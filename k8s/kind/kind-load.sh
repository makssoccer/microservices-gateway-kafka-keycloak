...
kind load docker-image -n microservices makskud/frontend:latest

#kind rollout restart deployment -n microservices makskud/api-gateway:0.0.2-SNAPSHOT
#kind rollout restart deployment -n microservices makskud/product-service:0.0.1-SNAPSHOT
#kind rollout restart deployment -n microservices makskud/order-service:0.0.2-SNAPSHOT
#kind rollout restart deployment -n microservices makskud/inventory-service:0.0.2-SNAPSHOT
#kind rollout restart deployment -n microservices makskud/notification-service:0.0.2-SNAPSHOT
#kind rollout restart deployment -n microservices makskud/frontend:latest